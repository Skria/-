...
local errorHelper = require("3rd.castl.modules.error_helper")
...
function internal.getFunctionProxy(fun)
    ...
    if proxy == nil then
        obj = obj or require("3rd.castl.core_objects").obj
...
function internal.defaultValueString(o)
    ...
    throw = throw or require("3rd.castl.jssupport").throw
...
function internal.ToObject(v)
    ...
    if tv == "boolean" then
        Boolean = Boolean or require("3rd.castl.constructor.boolean")
        return new(Boolean, v)
    elseif tv == "number" then
        Number = Number or require("3rd.castl.constructor.number")
        return new(Number, v)
    elseif tv == "string" then
        String = String or require("3rd.castl.constructor.string")
        return new(String, v)
    end
...
function internal.setNewMetatable(o, prototype)
    ...
    if protoMt and protoMt.__tostring then
        ...
        objectToString = objectToString or require("3rd.castl.core_objects").objectToString

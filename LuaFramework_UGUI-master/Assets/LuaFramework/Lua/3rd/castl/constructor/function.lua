...
local throw = require("3rd.castl.jssupport").throw
local functionProto = require("3rd.castl.protos").functionProto
...
Function = function(this, ...)
    if ... then
        ...
        if luajit then
            castl = castl or require("3rd.castl.jscompile.castl_jit")
            esprima = esprima or require("3rd.castl.jscompile.esprima_jit")
        else
            castl = castl or require("3rd.castl.jscompile.castl")
            esprima = esprima or require("3rd.castl.jscompile.esprima")
        end
        ...
        if castlResult.success then
            ...
            -- eval lua code
            runtime = runtime or require("3rd.castl.runtime")

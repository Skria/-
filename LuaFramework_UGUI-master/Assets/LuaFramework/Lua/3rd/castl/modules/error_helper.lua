...
local loadError = function()
    new = new or require("3rd.castl.core_objects").new
    Error = Error or require("3rd.castl.constructor.error.error")
end
local loadTypeError = function()
    new = new or require("3rd.castl.core_objects").new
    TypeError = TypeError or require("3rd.castl.constructor.error.type_error")
end
local loadSyntaxError = function()
    new = new or require("3rd.castl.core_objects").new
    SyntaxError = SyntaxError or require("3rd.castl.constructor.error.syntax_error")
end
local loadRangeError = function()
    new = new or require("3rd.castl.core_objects").new
    RangeError = RangeError or require("3rd.castl.constructor.error.range_error")
end
local loadReferenceError = function()
    new = new or require("3rd.castl.core_objects").new
    ReferenceError = ReferenceError or require("3rd.castl.constructor.error.reference_error")
end
local loadEvalError = function()
    new = new or require("3rd.castl.core_objects").new
    EvalError = EvalError or require("3rd.castl.constructor.error.eval_error")
end
local loadURIError = function()
    new = new or require("3rd.castl.core_objects").new
    URIError = URIError or require("3rd.castl.constructor.error.uri_error")
end
